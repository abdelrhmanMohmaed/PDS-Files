@if (in_array(Auth::user()->role_id, [1, 2]))
    <form action="{{ route('file.store', ['part' => $part->id, 'name' => 'Packfile']) }}" method="POST" class="w-100"
...
@else
    <a href="{{ route('file.show', ['part' => $part->id, 'name' => 'Packfile']) }}" class="btn btn-secondary">
        View Files
    </a>
@endif
