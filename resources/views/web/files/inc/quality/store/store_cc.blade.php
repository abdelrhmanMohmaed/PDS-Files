@if (in_array(Auth::user()->role_id, [1, 2]))
    <form action="{{ route('video.store', ['part' => $part->id, 'name' => 'Measurement']) }}" method="POST" class="w-100"
        ...
        <div class="d-flex align-items-end flex-column bd-highlight my-3 ">
            <div class="">
                ...
                <a href="{{ route('video.show', ['part' => $part->id, 'name' => 'Measurement']) }}" class="btn btn-secondary">
                    View Videos
                </a>
            </div>
        </div>
