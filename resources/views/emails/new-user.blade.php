...
<body style="border: 1px solid #33A1C9;border-radius: 2px;">
    ...
    <div style="float: left;padding: 20px;width: 100%;height: 300px;text-align: left;box-sizing: border-box;">
        <ul style="padding:15px;">
            <h4>A New account added into Injection Files By -
                <span style="color:#33A1C9;">{{ $actionBy->name }}</span>
            </h4>
            <li>Name: <span style="color:#33A1C9;"><i>{{ $event->user->name }}</i></span></li>
            <li>Email: <span style="color:#33A1C9;"><i>{{ $event->user->email }}</i></span></li>
            <li>Role: <span style="color:#33A1C9;"><i>{{ $event->user->role->name }}</i></span></li>
